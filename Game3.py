...
class Game():
    ...
    def __init__(self):
        ...
        self.mainMenuBackdrop = DirectFrame(
                                            frameSize = (-0.5/common.base.aspect2d.getSx(),
                                            1/common.base.aspect2d.getSx(), -1, 1)
                                           )

        self.motion_menu()

        self.mainMenuBackdrop.set_pos(0, 0, 0)

        self.titleHolder = self.mainMenuBackdrop.attachNewNode(PandaNode("title holder"))
        # self.titleHolder.setPos(0, 0, 100)
    ...
    def motion_menu(self):
        ...
        self.mainMenuBackdrop["frameTexture"] = self.mirror_buffer.get_texture()
    ...
    def startSectionInternal(self, index, data):
        ...
        for x in self.mirror_render.find_all_matches('**'):
            x.detach_node()
