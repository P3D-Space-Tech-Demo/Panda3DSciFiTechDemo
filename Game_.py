...
import Section2.Section2_ as Section2
import Section3.Section3_ as Section3
import Section2.Section2_ as Section4
...
class Game:
    ...
    def __init__(self):
        ...
        self.mainMenuBackdrop = DirectFrame(
                                            frameSize = (-1/base.aspect2d.getSx(), 1/base.aspect2d.getSx(), -1, 1),
                                           )
    ...
    def toggleFrameRateMeter(self):
        ...
        base.setFrameRateMeter(self.showFrameRateMeter)

    def windowUpdated(self, window):
        base.windowEvent(window)
        self.mainMenuBackdrop["frameSize"] = (-1/base.aspect2d.getSx(), 1/base.aspect2d.getSx(),
                                              -1/base.aspect2d.getSz(), 1/base.aspect2d.getSz())
        self.mainMenuPanel.setX(base.render2d, -1)
        self.mainMenuPanel["frameSize"] = (0, 1.25, -1/base.aspect2d.getSz(), 1/base.aspect2d.getSz())
        self.sectionMenu.setPos(base.render, -0.8, 0, 0)
        self.shipSelectionMenu.setPos(base.render, -0.6, 0, 0)
